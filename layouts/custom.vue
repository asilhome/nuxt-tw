  ...
  <!-- <div class="flex min-h-screen"> -->
    <main class="flex flex-col flex-1">
      <header class="sticky top-0">
        <VContainer sm>
          <div class="flex justify-between py-4 px-4">
            <h4 class="text-lg font-bold text-gray-500">hazizurin.dev</h4>
          </div>
        </VContainer>
      </header>
      ...
      <footer>
        ...
        <div class="mx-auto max-w-3xl py-4 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-4">
          <div class="flex justify-center space-x-6 md:order-2">
            <a href="https://www.instagram.com/asilhome" target="_blank" class="text-gray-400 hover:text-gray-500">
            ...
            <a href="https://twitter.com/asilhome" target="_blank" class="text-gray-400 hover:text-gray-500">
            ...
            <a href="https://www.linkedin.com/in/hazizurin-samad" target="_blank" class="text-gray-400 hover:text-gray-500">
          ...
          <div class="mt-4 md:order-1 md:mt-0">
            <p class="text-center text-base text-gray-400">
              &copy; 2020 - {{ formatted }} hazizurin.dev
            </p>
          </div>
        </div>
      </footer>

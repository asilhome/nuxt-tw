<template>
  <div>
    ...
    <section>
      <VContainer class="bg-green-100">
        <Card class="rounded-lg shadow mx-auto max-w-3xl">
          <CardContent class="bg-blue-100">
            <div class="sm:flex sm:items-center sm:justify-between">
              <div class="sm:flex sm:space-x-5">
                ...
                <div class="mt-4 text-center sm:mt-0 sm:pt-1 sm:text-left">
                  ...
                  <p class="text-xl font-bold text-gray-900 sm:text-2xl">Asil</p>
                  <p class="text-sm font-medium text-gray-600">Freelance Programmer</p>
                </div>
              </div>
    ...
    <!-- Welcome panel -->
    <section aria-labelledby="profile-overview-title" class="py-10">
      <VContainer>
